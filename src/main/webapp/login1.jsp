...
<div id="login">
    ...
    <div class="wrapper">
        ...
        <div class="login sign-in-htm">
            <form action="${pageContext.request.contextPath}/user/login" class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
                ...
                <div class="pad input-container">
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" name="username" type="text"
                                       id="login-username"
                        ...
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" name="password" type="password"
                        ...
                        <span class="input input--hideo input--verify_code">
								<input class="input__field input__field--hideo" name="code" type="text"
                ...
                <div class="form-actions">
                    ...
                    <input class="btn btn-primary" type="submit" tabindex="3" onclick="login1()" value="登录"
                           style="color:white;"/>
                </div>
            </form>
        </div>
